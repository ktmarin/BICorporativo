...
namespace CapaLogica
{
    public class GestorIN04
    {
        ...
        public static DataTable UserName(string usuario)
        {
            ...
            try
            {
                ...
                if (DataAccess.EjecutarProcedimientoAlmacenado2("username_select", Parametros, ref dt, conexion, ref error))
                {
                    if (error != "")
                    {
                        GestorSQLserver.EscribirLog(error);
        ...
        public static int Login(string usuario, string contrasena, ref string error2)
        {
            ...
            try
            {
                ...
                if (DataAccess.EjecutarProcedimientoAlmacenado2("WEB_LoginHOW01", Parametros, ref dt, conexion,ref error))
                {
                    if (error != "")
                    {
                        error2 = error;
