...
{
    public sealed class GestorNumAlet
    {
        ...
        public const String SeparadorDecimalSalidaDefault = "dólares con";
        ...
        public GestorNumAlet(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
        {
        ...
        {
            return GestorNumAlet.ToString(Numero, CultureInfo.CurrentCulture);
        }
