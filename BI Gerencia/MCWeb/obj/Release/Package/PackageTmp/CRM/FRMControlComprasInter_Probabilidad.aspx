...
<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCRM.Master" AutoEventWireup="true" CodeBehind="FRMControlComprasInter_Probabilidad.aspx.cs" Inherits="MCWebHogar.CRM.Reports.FRMControlComprasInter_Probabilidad"   EnableEventValidation="false" %>
                          ...
                          <asp:ListItem>Dona</asp:ListItem>
                                            ...
                                            <div id="Graficos" style="width: 100%; margin: 0px; background-color: transparent; height: 385px;">
                                                ...
                                                <asp:Chart ID="ChartProbabilidad" runat="server" Height="385px" Width="500px" BorderlineWidth="3">
                                                    <Titles>
                                                        <asp:Title BorderColor="Gray" Docking="Top" Font="Arial, 15pt, style=Bold" ForeColor="Black" Text="Proyectos próximos 3 meses">
                                                        </asp:Title>
                                                    </Titles>
                                                    <Series>
