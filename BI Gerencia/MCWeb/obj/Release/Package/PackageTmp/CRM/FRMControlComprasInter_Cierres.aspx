...
<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCRM.Master" AutoEventWireup="true" CodeBehind="FRMControlComprasInter_Cierres.aspx.cs" Inherits="MCWebHogar.CRM.Reports.FRMControlComprasInter_Cierres"   EnableEventValidation="false" %>
                      ...
                      <asp:DropDownList
                          ...
                          <asp:ListItem>Dona</asp:ListItem>
                                            ...
                                            <div id="Graficos" style="width: 100%; margin: 0px; background-color: transparent; height: 385px;">
                                                ...
                                                <asp:Chart ID="ChartVentas" runat="server" BorderlineWidth="3" Height="385px" Width="500px">
                                                    <Titles>
                                                        <asp:Title BorderColor="Gray" Docking="Top" Font="Arial, 15pt, style=Bold" ForeColor="Black" Text="Cierres para el mes">
                                                        </asp:Title>
                                                    </Titles>
                                                    <Series>
                                                        <asp:Series BorderWidth="3" ChartType="Pie" Color="56, 120, 192" IsValueShownAsLabel="True" LabelBorderWidth="5" LabelFormat="#,0;(#,0)" Legend="Legend1" MarkerStep="1" Name="FechaCierre" YValuesPerPoint="1">
                                                        </asp:Series>
