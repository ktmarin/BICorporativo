<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCRM.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="FRMET00Menu.aspx.cs" Inherits="MCWebHogar.CRM.Encuestas.FRMET00Menu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class=" container" style="background-color: rgba(251,251,251,.6); overflow:hidden;">
             <%--<div class="main container">--%>
              <h2 class="colortitulo">SAC - Encuestas</h2>

            
                 <div style="text-align:left;">
                   <asp:LinkButton ID="LinkButton15" runat="server" OnClick="Button1_Click"  CssClass="btn btn-danger" >  
                                    ...
                                    <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="hidden-xs" HeaderStyle-CssClass="hidden-xs">
                                     ...
                                     <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="visible-lg" HeaderStyle-CssClass="visible-lg">
                                        <HeaderTemplate>
                                             ...
                                             <br />
                                            <asp:Label ID="Lbl_sCodigo_Cliente" runat="server" Text="sCodigo_Cliente"></asp:Label>
                                        </HeaderTemplate>
                                          <ItemTemplate>
                                            <asp:Label ID="Lbl_sCodigo_Cliente2" runat="server" Text='<%#Eval("sCodigo_Cliente") %>'></asp:Label>
                                       </ItemTemplate>      
                                    </asp:TemplateField>
