<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCRM.Master" AutoEventWireup="true" CodeBehind="FRMCalendarioEvento.aspx.cs"
     Inherits="MCWebHogar.CRM.FRMCalendarioEvento" EnableSessionState="true" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#calendar').fullCalendar({
                ...
                events: '../CRM/EventosCalendario/Calendario.ashx?e=' + e,
                locale: 'es',
                dayClick: function (date, jsEvent, view) {
                    ...
                    document.getElementById('<%=TXT_NombreEvento.ClientID%>').value = "";
                    document.getElementById('<%=TXT_Ubicacion.ClientID%>').value = "";
                    ...
                    document.getElementById('<%=CMB_Host.ClientID %>').selectedindex = "0";
                    $("#<%=CHK_TodoElDia.ClientID%>").prop("checked", false);
                    ...
                    document.getElementById('<%=CMB_ARepetir.ClientID%>').value = date.format('YYYY-MM-DD');
                    document.getElementById('<%=CMB_DeRepetir.ClientID%>').value = date.format('YYYY-MM-DD');
        ...
        function validarEvento() {
            var CMB_Motivo = document.getElementById('<%= CMBMotivo.ClientID %>');
       ...
       function validarFechaActual(FechaMenor) {
        ...
        function validar() {
            ...
            var TXT_Correo = document.getElementById('<%= TXTCorreoManual.ClientID %>').value.trim();
    ...
    <div class="main container">
              <h2 class="colortitulo">Calendario</h2>
                 <div class="col-md-12">
                    ...
                    <ContentTemplate>
                     <asp:LinkButton runat="server" OnClientClick="return  $('#popFiltro').dialog('open');return false;" style="text-decoration:none" ID="CMD_ReporteCliente" CssClass="btn btn-success" >Reporte Eventos <span class="glyphicon glyphicon-th-list"></span></asp:LinkButton> <%--OnClick="CMD_ReporteCliente_Click"--%>
                 </ContentTemplate>
                </asp:UpdatePanel>
                        </div>
                  <br />
        ...
        <div class="modal-dialog" id="DLG_Editar">
            ...
            <div class="modal-content" style="box-shadow: 0 5px 15px rgba(206, 206, 214, 0.84);">
                <div style="background-color:black" class="modal-header">
                    ...
                    <h4 class="modal-title" style="color: white;text-shadow: 0 0 5px #d8c3c3;">Evento Nuevo</h4>
                </div>
                        ...
                        <ContentTemplate>
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="TXT_NombreEvento" runat="server" CssClass="form-control" placeholder="Digite el Nombre">Nuevo Evento</asp:TextBox>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <asp:DropDownList ID="CMBTipoCalendario" CssClass="form-control" runat="server">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="TXT_Ubicacion" runat="server" CssClass="form-control" placeholder="Digite la Ubicación"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label for="CHK_TodoElDia">Todo el Día: </label>
                                    <asp:CheckBox runat="server" onclick="cambioTodoelDia();" ID="CHK_TodoElDia"/>
                                </div>
                                <div class="form-group">
                                    <div  class="form-inline">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <asp:DropDownList ID="CMB_Host" CssClass="form-control" runat="server">
                                            <asp:ListItem Value="jose.sanchez@euromobilia.com">Vertice Costa Rica</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                </div>
                               ...
                               <%-- <div class="form-group">
                                        <asp:Label runat="server">Participantes:</asp:Label>
                                    <hr />
                                </div>--%>
                               ...
                               <div class="row">
                                   <div class="col-md-6">
                                         <div class="form-group">
                                                <asp:Label runat="server">Participantes Cargados:</asp:Label>
                                        </div>

                                        <div class="form-group">
                                                <asp:LinkButton ID="CMD_AgregarParticipante" OnClientClick="return AgregarParticipante();" runat="server"><span id="SPAN_AgregarParticipante" class="glyphicon glyphicon-plus" style="color:green;text-decoration:none;"></span>Agregar</asp:LinkButton>
                                   ...
                                   <div class="col-md-6">
                                             ...
                                             <div class="form-group">
                                                 <asp:UpdatePanel ID="UDPCorreoManual" runat="server" UpdateMode="Conditional">
                                                 <ContentTemplate>

                                                     <asp:Label runat="server">Participante Manual:</asp:Label>
                                        
                                                    <asp:LinkButton ID="CMD_AgregarParticipanteMn" OnClientClick="return validar();" runat="server" OnClick="CMD_AgregarParticipanteMn_Click">
                                                        <span id="SPAN_AgregarParticipanteM" class="glyphicon glyphicon-plus" style="color:green;text-decoration:none;"></span>Agregar</asp:LinkButton>

                                                     <asp:TextBox CssClass="form-control" ID="TXTCorreoManual" TextMode="Email" runat="server" placeholder="Ej: correo@dominio.com"></asp:TextBox>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <asp:DropDownList ID="CMBMotivo" CssClass="form-control" runat="server">
                ...
                <div class="modal-footer">
                    <div class="col-lg-12 col-xs-12 col-lg-12">
                        <div class="form-inline" style="text-align:center">
                            <div class="form-group">
                                <asp:LinkButton runat="server" OnClientClick="return validarEvento();" ID="CMD_Aceptar" OnClick="CMD_Aceptar_Click" CssClass="form-control"><span class="glyphicon glyphicon-check" style="color:green"> </span>Aceptar</asp:LinkButton>
                            </div>
                            <div class="form-group">
    ...
    <div class="modal fade" id="MDL_MostrarEvento" role="dialog">
        ...
        <div class="modal-dialog" id="DLG_Modificar">
            ...
            <div class="modal-content" style="box-shadow: 0 5px 15px rgba(206, 206, 214, 0.84);">
                <div style="background-color:black" class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" style="color: white;text-shadow: 0 0 5px #d8c3c3;">Información Evento</h4>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <div class="row">
                           <div class="col-md-6">
                                <asp:LinkButton runat="server" OnClientClick="return validarEvento();"  OnClick="CMD_ActuaizarEvento_Click" 
