<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCRM.Master" AutoEventWireup="true" CodeBehind="FRMCalendarioDisCopia.aspx.cs" Inherits="MCWebHogar.CRM.FRMCalendarioDis" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            function GenerateCalender(events) {
                ...
                var cat = document.getElementById('<%= cboCategorias.ClientID %>').value;
              ...
              <%--<h2 class="colortitulo">Calendario</h2>--%>
                  <br /> <br />
                     <div class="row">
                         ...
                         <div class="col-md-4"> Categoría:&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:DropDownList ID="cboCategorias" runat="server" CssClass="ddlclass"> 
