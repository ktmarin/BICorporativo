...
namespace CapaDatos
{
    ...
    {
        public static string SIAWINDB;
        public static string CEMDB;
        ...
        public static List<string> EjecutarList(SqlCommand command, string campo)
        {
            ...
            try
            {
                ...
                using (SqlDataReader sdr = command.ExecuteReader())
                {
                    while (sdr.Read())
                    {
                        oList.Add(sdr[campo].ToString()); //.getstring(1)
                    }
                }   
            }
            catch (Exception ex)
        ...
        public static int GESTOR_MANT_CEM(DataTable Parametros, string Procedure)
        {
            int confirmacion = 0;
            ...
            try
            {
                ...
                if (conexion.State != ConnectionState.Closed)
                {
                    ...
                    //DA.Fill(DT);
                    confirmacion = Convert.ToInt32(command.ExecuteNonQuery());
                }
            }//fin del try
        ...
        public static String GESTOR_MANT_CEM2(DataTable Parametros, string Procedure)
        {
            String Retorno = "";
            SqlConnection conexion = new SqlConnection(CEMDB);
            try
